      ...
      .then(
        (res: any) => {
          ...
          if (data && data.length > 0) {
            ...
            this.vehicleDetails.BoatMaintenance = data[0].BoatMaintenance;
            this.vehicleDetails.BoatBatteries = data[0].BoatBatteries;
            this.vehicleDetails.BoatCrew = data[0].BoatCrew;
